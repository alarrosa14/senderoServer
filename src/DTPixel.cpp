...
DTPixel::DTPixel(int iId,float iR, float iG, float iB,float iA, float iX, float iY, float iZ, ofVec3f iFront, ofVec3f iUp, string iMeshName, int iLedTypeId){
	this->id=iId;
	this->R=iR;
	this->G=iG;
	this->B=iB;
